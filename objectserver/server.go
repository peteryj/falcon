...
import (
	...
	"github.com/iqiyi/falcon/common/middleware"
	"github.com/iqiyi/falcon/common/srv"
	"github.com/iqiyi/falcon/objectserver/engine"

	// Register different engine
	_ "github.com/iqiyi/falcon/objectserver/engine/pack"
	_ "github.com/iqiyi/falcon/objectserver/engine/swift"
)
...
func (s *ObjectServer) buildHandler(config conf.Config) http.Handler {
	...
	metricsScope, s.metricsCloser = tally.NewRootScope(
		tally.ScopeOptions{
			Prefix:         fmt.Sprintf("falcon_object_%d", s.port),
